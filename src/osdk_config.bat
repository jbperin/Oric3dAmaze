...
REM need to add %OSDKCPPFLAGS% in parameters of cpp.exe preprocess command in file %OSDK%\bin\make.bat
...
:English
SET OSDKCPPFLAGS=-DLANG=4
SET OSDKNAME=POG_OP1_EN
GOTO End
:French
SET OSDKCPPFLAGS=-DLANG=1
SET OSDKNAME=POG_OP1_FR
GOTO End
:Spanish
SET OSDKCPPFLAGS=-DLANG=2
SET OSDKNAME=POG_OP1_ES
GOTO End
:Italian
SET OSDKCPPFLAGS=-DLANG=3
